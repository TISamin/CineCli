...
const CinemaSeat = (function () {
    // API base URL. Override via <script>window.__API_BASE__ = 'https://api.example.com';</script>
    // before app.js loads. Defaults to same-origin (works on Render + docker-compose).
